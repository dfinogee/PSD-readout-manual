...
Waveform offset parameter determine waveform position in gate, if it is 0, first point in data is the point above threshold. Maximum offset value is 13. Latched baseline level is value before point above threshold.
